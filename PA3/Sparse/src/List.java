...
public class List {
	...
	int index() {
		if (cursor != null) { // If cursor is defined, returns the index of the
								// cursor element,
			return index;
	...
	Object get() {// Returns cursor element. Pre: length()>0, index()>=0
		if (length < 1) {
			throw new RuntimeException(
					"Invalid, List Class Error: cannot call get() on empty list");
		}
		if (index() < 0) {
			throw new RuntimeException(
					"Invalid, List Class Error: cannot call get() with undefined index");
		}
	...
	boolean equals(List L) {
		...
		if (length == L.length) {// Returns true if and only if this List and L
									// are the same
	...
	void prepend(Object entry) {// Insert new element into this List. If List is
								// non-empty,
	...
	void append(Object entry) {// Insert new element into this List. If List is
								// non-empty,
	...
	List copy() {// Returns a new List representing the same integer sequence as
					// this
